...
public class PDXReportQueueProcessUtil {
	/**
	 ...
	 */
	private static final Logger logger = LogManager.getLogger(PDXReportQueueProcessUtil.class);
	...
	public static void addQueueEntry(String queueName, String method, String className, Class<?> argTypes[], Object args[] ) {
		try {
			...
			System.out.println("0001 ---addQueueEntry--- start");
			...
			System.out.println("0010 ---addQueueEntry--- end");
	...
	public static ProcessingQueue getProcessQueue(String strQueueName) {
		...
		try {
			...
			logger.error("ERROR# Unable to get process queue for PDX Report");
		} catch (WTException e) {
			logger.error("ERROR# Unable to get process queue for PDX Report");
		}
