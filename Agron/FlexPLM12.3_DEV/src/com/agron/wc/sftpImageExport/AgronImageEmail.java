...
public class AgronImageEmail {

	private static WTUser user = null;
	public static String fromEmailId = LCSProperties.get("com.agron.wc.sftpImageExport.FromMailId","FlexPLMSupport@agron.com");
	public static String userEmail = LCSProperties.get("com.agron.wc.sftpImageExport.userEmail");
	 ...
	 * @throws WTException
	 */
	public static void notifyPLMUser(boolean isValidFile, int totalRecord, int successCount, int failedCount, String dataLogFileName, String error) throws WTException {
		...
		if(isValidFile) {
			emailContent.append("SFTP thumbnail export summary.");
		}else {
			emailContent.append("SFTP thumbnail is failed to upload data.");
			emailContent.append(error);
		}
		//String emailSubject = "Data Upload Summary";
		String emailSubject=  LCSProperties.get("com.agron.wc.sftpImageExport.emailSubject");
		emailContent.append(System.getProperty("line.separator"));
		emailContent.append("------------------------------------------------------");
		emailContent.append(System.getProperty("line.separator"));
		emailContent.append("Total Records : "+(successCount+failedCount));
		emailContent.append(System.getProperty("line.separator"));
		emailContent.append("Success : "+successCount);
		emailContent.append(System.getProperty("line.separator"));
		emailContent.append("Failed : "+failedCount);
		emailContent.append(System.getProperty("line.separator"));
	//	emailContent.append("SKU Thumbnail not updated: "+(totalRecord -(failedCount+successCount)));
	//	emailContent.append(System.getProperty("line.separator"));
		emailContent.append("------------------------------------------------------");
		emailContent.append(System.getProperty("line.separator"));
